...
define('ember-cli-chartjs/components/ember-zingchart', ['exports', 'ember'], function (exports, Ember) {
  ...
  exports['default'] = Ember['default'].Component.extend({
    ...
    buildOptions: Ember['default'].computed("renderOptions", "chartData.@each.isLoaded", "themeData", function () {
    ...
    renderLater: function () {
      Ember['default'].run.scheduleOnce("afterRender", this, "render");
    },
    render: function () {
      ...
      console.log(options);
      Ember['default'].zingchart.render(options);
    },
    _destroyChart: (function () {
      var self = this;
      Ember['default'].zingchart.exec(self.elementId, "destroy");
    }).on("willDestroyElement")
...
define('ember-cli-chartjs/controllers/application', ['exports', 'ember'], function (exports, Ember) {
  ...
  exports['default'] = Ember['default'].Controller.extend({
    ...
    myThemeData: {
      palette: {
        line: [["#ffffff", "#196eed", "#196eed", "#196eed"], ["#ffffff", "#d94530", "#d94530", "#d94530"], ["#ffffff", "#fdb82b", "#fdb82b", "#fdb82b"], ["#ffffff", "#159755", "#159755", "#159755"], ["#ffffff", "#8e8e8e", "#8e8e8e", "#8e8e8e"]]
      },
      graph: {
...
define('ember-cli-chartjs/templates/index', ['exports', 'ember'], function (exports, Ember) {
  ...
  helpers = this.merge(helpers, Ember['default'].Handlebars.helpers); data = data || {};
    ...
    data.buffer.push(escapeExpression((helper = helpers['ember-zingchart'] || (depth0 && depth0['ember-zingchart']),options={hash:{
      'renderOptions': ("myRenderOptions"),
      'chartData': ("myChartData"),
      'themeData': ("myThemeData")
    },hashTypes:{'renderOptions': "ID",'chartData': "ID",'themeData': "ID"},hashContexts:{'renderOptions': depth0,'chartData': depth0,'themeData': depth0},contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "ember-zingchart", options))));
    data.buffer.push("\n      </div>\n    </div>\n  </div>\n\n  <div class=\"row\">\n    <div class=\"small-12 medium-12 large-12 columns\">\n      <div class=\"feature-box\">\n        <h4>Line Chart</h4> ");
...
define('ember-cli-chartjs/tests/components/ember-zingchart.jshint', function () {

  'use strict';

  module('JSHint - components');
  test('components/ember-zingchart.js should pass jshint', function() { 
    ok(true, 'components/ember-zingchart.js should pass jshint.'); 
  });
